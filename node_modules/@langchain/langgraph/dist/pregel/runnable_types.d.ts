...
export interface LangGraphRunnableConfig<ContextType extends Record<string, any> = Record<string, any>> extends RunnableConfig<ContextType> {
    context?: ContextType;
    store?: BaseStore;
    writer?: (chunk: unknown) => void;
}
export interface Runtime<ContextType extends Record<string, unknown> = Record<string, unknown>> {
    context?: ContextType;
    store?: BaseStore;
    writer?: (chunk: unknown) => void;
    signal?: AbortSignal;
